...
function shortLessonTitle(title: string | null): string {
  const value = (title ?? "Current lesson").trim();
  if (value.length <= 33) {
    return value;
  }
...
export function UnifiedDashboard({ mode = "sensei" }: UnifiedDashboardProps) {
  const {
    snapshots,
    unresolved,
    selected,
  ...
  return (
    <main className={`container grid dojo-dashboard ${mode === "tv" ? "dojo-dashboard-tv" : "dojo-dashboard-sensei"}`}>
              ...
              <div className="roster-left-box">
                ...
                >
                  ...
                  <AutoFitText
                    ...
                    minFontPx={mode === "tv" ? 12 : 9}
                  />
                </button>
              </div>

              <div className="roster-right-box">
                <div className="roster-meta-line">
                  ...
                  >
                    {student.curriculum.level_number && student.progress.total > 0
                      ? `Level ${student.curriculum.level_number} | ${shortLessonTitle(student.curriculum.lesson_title)}`
                      : "Level - | Curriculum not set"}
                  </button>
